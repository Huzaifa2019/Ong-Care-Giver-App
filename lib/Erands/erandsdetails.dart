...
import 'package:ong/Erands/erandslocation.dart';
import 'package:ong/Tutors/tutorlocation.dart';

class ErandsDetailsPage extends StatefulWidget {
  @override
  _StandardImageListState createState() => _StandardImageListState();
}

class _StandardImageListState extends State<ErandsDetailsPage> {
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Expanded(
                            ...
                            flex: 1,
                            child: Text(
                                'What sorts of errands/jobs need to be completed?')),
                        SizedBox(width: 10.0),
                      ],
                    ),
                  ),
          ...
          child: GestureDetector(
            onTap: () {
              Navigator.push(
                  context,
                  new MaterialPageRoute(
                      builder: (context) => ErandsLocationPage()));
            },
            child: new Container(
              height: 40,
              width: MediaQuery.of(context).size.width,

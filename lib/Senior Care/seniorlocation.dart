...
import 'package:ong/BabySitter/babycreateaccount.dart';
import 'package:ong/GMaps/api.dart';
import 'package:ong/GMaps/placeModel.dart';
import 'package:ong/GeoLocation/getLocation.dart';
import 'package:ong/Nanny/nannycreataccount.dart';
import 'package:ong/Senior%20Care/seniorcreateaccount.dart';

class SeniorLocationPage extends StatefulWidget {
  @override
...
class _MyHomePageState extends State<SeniorLocationPage>
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(
                context,
                new MaterialPageRoute(
                    builder: (context) => SeniorCreateAccountScreen()));
          },
          child: new Container(
            height: 40,
            width: MediaQuery.of(context).size.width,

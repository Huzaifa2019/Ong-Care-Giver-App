...
import 'package:ong/profilesetup.dart';

import 'getLocation.dart';

class StreetAddressPage extends StatefulWidget {
  @override
...
class _MyHomePageState extends State<StreetAddressPage>
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Expanded(
                          // optional flex property if flex is 1 because the default flex is 1
                          flex: 1,
                          child: Text('Appartment/Building')),
                      SizedBox(width: 10.0),
                    ],
                  ),
                ),

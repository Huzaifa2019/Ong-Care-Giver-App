...
import 'package:ong/SpecialNeeds/specialcreateaccount.dart';

class SpecialLocationPage extends StatefulWidget {
  @override
...
class _MyHomePageState extends State<SpecialLocationPage>
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(
                context,
                new MaterialPageRoute(
                    builder: (context) => SpecialCreateAccountScreen()));
          },
          child: new Container(
            height: 40,
            width: MediaQuery.of(context).size.width,
